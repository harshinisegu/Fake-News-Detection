...
1️⃣Text preprocessing using NLP techniques

2️⃣TF-IDF Vectorization

3️⃣Logistic Regression model

4️⃣92% accuracy achieved

5️⃣Saved trained model and vectorizer for reuse

6️⃣Deployable Python application (app.py)
